...
<br/><br/>
Here are also a list of more difficult things to do if you want (I don't expect to do those all by yourself, even pull requests that lay down the foundations or a one that do a small contribution about these features are higly appreciated):
